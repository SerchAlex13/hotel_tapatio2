<x-plantilla>
    ...
    <div class="container w-75 d-flex justify-content-evenly p-3">
        <div class="p-3">
            <h1 class="display-6">Saldo pendiente: $3499.99</h1>
        </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="container w-75 d-flex justify-content-end p-3">
                        ...
                        <div class="col-md-2 p-3">
                            <a href="{{ route('factura.correo', \Auth::user()) }}" class="btn btn-info">Pagar</a>
                        </div>
